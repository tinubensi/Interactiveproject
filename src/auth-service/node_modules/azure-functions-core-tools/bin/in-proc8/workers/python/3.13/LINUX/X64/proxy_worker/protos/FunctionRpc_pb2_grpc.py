...
from proxy_worker.protos import FunctionRpc_pb2 as FunctionRpc__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in FunctionRpc_pb2_grpc.py depends on'
...
def add_FunctionRpcServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('AzureFunctionsRpcMessages.FunctionRpc', rpc_method_handlers)
