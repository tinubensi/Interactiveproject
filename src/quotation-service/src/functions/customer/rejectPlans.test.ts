...
describe('Reject Plans API', () => {
  ...
  it('should successfully process plan rejection', async () => {
    ...
    (mockCosmosService.getQuotationByToken as any).mockImplementation(async () => mockQuotation);
    (mockCosmosService.updateQuotation as any).mockImplementation(async () => undefined);
    (mockEventGridService.publishEvent as any).mockImplementation(async () => undefined);
    (mockEventGridService.publishQuotationRejected as any).mockImplementation(async () => undefined);
