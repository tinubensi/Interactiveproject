...
from proxy_worker.protos.identity import ClaimsIdentityRpc_pb2 as identity_dot_ClaimsIdentityRpc__pb2
from proxy_worker.protos.shared import NullableTypes_pb2 as shared_dot_NullableTypes__pb2
