...
class DurableClient {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (response.status) {
                case 202:
                    return;
                case 404:
                    return Promise.reject(new Error(response.data || `No instance with ID '${instanceId}' found.`));
                case 412:
    ...
    startNew(orchestratorFunctionName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.clientData.rpcBaseUrl) {
                const urlObj = new URL(`orchestrators/${orchestratorFunctionName}${instanceIdPath}`, this.clientData.rpcBaseUrl);
                ...
                if (options === null || options === void 0 ? void 0 : options.version) {
                    ...
                    requestUrl = `${requestUrl}${separator}version=${encodeURIComponent(options.version)}`;
                }
            }
            const headers = this.getDistributedTracingHeaders();
