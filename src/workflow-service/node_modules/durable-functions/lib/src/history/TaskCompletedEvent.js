...
class TaskCompletedEvent extends HistoryEvent_1.HistoryEvent {
    constructor(options) {
        super(HistoryEventType_1.HistoryEventType.TaskCompleted, options.eventId, options.isPlayed, options.timestamp);
