...
export type StepType = 'action' | 'decision' | 'parallel' | 'wait' | 'loop' | 'human' | 'subworkflow' | 'transform' | 'script' | 'setVariable' | 'delay' | 'retry' | 'compensate' | 'terminate';
export type ActionType = 'http_request' | 'publish_event' | 'send_command' | 'cosmos_query' | 'cosmos_upsert' | 'cosmos_delete' | 'send_notification' | 'call_function';
export type TriggerType = 'event' | 'http' | 'schedule' | 'manual';
export type InstanceStatus = 'pending' | 'running' | 'waiting' | 'paused' | 'completed' | 'failed' | 'cancelled' | 'timed_out';
export type StepExecutionStatus = 'pending' | 'running' | 'completed' | 'failed' | 'skipped' | 'waiting';
export type ConditionOperator = 'eq' | 'neq' | 'gt' | 'gte' | 'lt' | 'lte' | 'contains' | 'startsWith' | 'endsWith' | 'in' | 'notIn' | 'exists' | 'notExists' | 'regex' | 'and' | 'or' | 'not';
...
export type TriggerConfig = EventTriggerConfig | HttpTriggerConfig | ScheduleTriggerConfig | ManualTriggerConfig;
...
export type ActionConfig = HttpRequestConfig | PublishEventConfig | SendCommandConfig | CosmosQueryConfig | CosmosUpsertConfig | CosmosDeleteConfig | SendNotificationConfig | CallFunctionConfig;
