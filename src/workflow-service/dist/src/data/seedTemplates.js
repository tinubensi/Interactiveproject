...
exports.seedTemplates = exports.INSURANCE_TEMPLATES = void 0;
exports.INSURANCE_TEMPLATES = [
    // ============================================================================
    ...
    // ============================================================================
    {
        ...
        description: 'Standard new business workflow from intake form submission to policy binding. Includes quote generation, optional manager approval for high-value quotes, and AML compliance check.',
        ...
        baseWorkflow: {
                ...
                },
                {
                    ...
                    humanConfig: {
                        ...
                        context: {
                            ...
                            instructions: 'High-value quote requires manager approval before proceeding to customer.',
                        },
                    },
                    transitions: [
                        {
            ...
            settings: {
                maxExecutionDurationSeconds: 604800,
...
- Add additional compliance checks in the parallel step
    ...
    // ============================================================================
    {
        ...
        description: 'Automated policy renewal workflow triggered 60 days before expiry. Pre-fills renewal form and optionally generates renewal quotes.',
        category: 'renewal',
        ...
        baseWorkflow: {
            ...
            settings: {
                maxExecutionDurationSeconds: 2592000,
                enableAuditLogging: true,
            },
        },
    ...
    // ============================================================================
    {
        ...
        description: 'Generic document review and approval workflow. Configurable approver roles and escalation.',
        category: 'approval',
    ...
    // ============================================================================
    {
        ...
        description: 'Automated lead scoring and qualification workflow with assignment to agents.',
    ...
    // ============================================================================
    {
        ...
        description: 'Claims intake workflow from first notice through initial assessment and adjuster assignment.',
        category: 'claims',
...
async function seedTemplates() {
    ...
    console.log(`Ready to seed ${exports.INSURANCE_TEMPLATES.length} templates`);
}
exports.seedTemplates = seedTemplates;
//# sourceMappingURL=seedTemplates.js.map